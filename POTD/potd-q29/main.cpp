 ...
 */
  ...
  for (TreeTraversal::Iterator it = pot.begin(); it != pot.end(); ++it) {
      cout<<(*it)->val_<<" ";
  }
  cout<<endl;
  ...
  for (TreeTraversal::Iterator it = iot.begin(); it != iot.end(); ++it) {
      cout<<(*it)->val_<<" ";
  }
  cout<<endl;

  odd oot(root);
  cout<<"Inorder odd Traversal:  ";
  for (TreeTraversal::Iterator it = oot.begin(); it != oot.end(); ++it) {
      cout<<(*it)->val_<<" ";
  }
  cout<<endl;
  return 0;
